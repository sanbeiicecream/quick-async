  ...
  return (
    <main>
      <Virtuoso
        style={{ height: '86vh' }}
        data={props.messages || []}
        itemContent={(index, item: Messages[0]) => (
